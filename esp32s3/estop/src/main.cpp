...
uint8_t WHICH_ADDR = 5; //<-- multiple receivers makes it unclear whether transmit succeeds, pick one address
uint8_t send_to_addrs[][6] = {
    ...
    {0x74, 0x4D, 0xBD, 0x81, 0x09, 0x50}, // COM6
    {0x74, 0x4D, 0xBD, 0x97, 0x6F, 0xF8}, // COM7
